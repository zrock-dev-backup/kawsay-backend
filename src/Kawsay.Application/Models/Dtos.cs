...
public record TimetableCreateDto(string Name, string Timezone, DateOnly StartDate, DateOnly EndDate, List<string> Days, List<PeriodDto> Periods, List<string> SubjectIds);
...
public record CourseRequirementCreateDto(string SubjectId, string? TeacherId, string? StudentGroupId, int DurationInPeriods, int FrequencyPerWeek, string Priority, string ClassType);
