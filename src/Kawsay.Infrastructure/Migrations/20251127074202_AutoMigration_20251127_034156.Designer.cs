...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251127074202_AutoMigration_20251127_034156")]
    partial class AutoMigration_20251127_034156
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.CourseRequirementEntity", b =>
                {
                    ...
                    b.Property<int?>("PreferredTeacherId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.SoftSchedulingPreferenceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("SoftSchedulingPreferenceEntity");
                });
            ...
            modelBuilder.Entity("Domain.Entities.StudentIssueEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.TeacherQualificationEntity", b =>
                {
                    b.Property<int>("TeacherId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Domain.Entities.TimetableAssignmentEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MaximumWorkload")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TimetableId", "TeacherId");

                    b.ToTable("TimetableAssignments");
                });
            ...
            modelBuilder.Entity("Domain.Entities.CourseRequirementEntity", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.TeacherEntity", "PreferredTeacher")
                        .WithMany()
                        .HasForeignKey("PreferredTeacherId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.OwnsOne("Kawsay.Domain.ValueObjects.DateRange", "EffectiveDateRange", b1 =>
                        {
                            b1.Property<int>("CourseRequirementEntityId")
                                .HasColumnType("integer");
                            ...
                            b1.HasKey("CourseRequirementEntityId");

                            b1.ToTable("CourseRequirements");

                            b1.WithOwner()
                                .HasForeignKey("CourseRequirementEntityId");
                        });

                    b.Navigation("Course");

                    b.Navigation("EffectiveDateRange")
                        .IsRequired();

                    b.Navigation("PreferredTeacher");
            ...
            modelBuilder.Entity("Domain.Entities.SoftSchedulingPreferenceEntity", b =>
                {
                    b.HasOne("Domain.Entities.CourseRequirementEntity", "CourseRequirement")
                        .WithMany("SoftPreferences")
            ...
            modelBuilder.Entity("Domain.Entities.TeacherEntity", b =>
                {
                    ...
                    b.Navigation("CourseQualifications");
                });
